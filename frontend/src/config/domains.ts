...
> = {
  ok: {
    dot: 'bg-emerald-500',
    badge: 'bg-emerald-500/10 text-emerald-700 ring-1 ring-inset ring-emerald-600/20 dark:text-emerald-400',
    text: 'text-emerald-600 dark:text-emerald-400',
  },
  warn: {
    dot: 'bg-amber-500',
    badge: 'bg-amber-500/10 text-amber-700 ring-1 ring-inset ring-amber-600/20 dark:text-amber-400',
    text: 'text-amber-600 dark:text-amber-400',
  },
  risk: {
    dot: 'bg-rose-500',
    badge: 'bg-rose-500/10 text-rose-700 ring-1 ring-inset ring-rose-600/20 dark:text-rose-400',
    text: 'text-rose-600 dark:text-rose-400',
  },
  neutral: {
    dot: 'bg-slate-400',
    badge: 'bg-slate-500/10 text-slate-600 ring-1 ring-inset ring-slate-500/20 dark:text-slate-400',
